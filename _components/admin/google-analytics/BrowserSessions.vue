      ...
      <div class="q-container">
         <div class="row box">
            <div class="col-12 q-pa-md">
               <div class="text-h6 q-mb-lg"><i aria-hidden="true" class="fas fa-window-restore"/>
         ...
         getVisitorsAndPages() {
            return new Promise((resolve, reject) => {
               ...
               this.$crud.index('apiRoutes.qanalytics.google', params).then(response => {
                  let data = response.data.browserSession
                  let series = [
                     {
                        innerSize: '70%',
                        name: 'sesiones',
                  ...
                  console.log(this.chartOptions.series, series)
